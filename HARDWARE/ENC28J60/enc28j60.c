...
//	RCC->APB2ENR |= 1 << 3;     //??PORTB??, INT=PA0, RST=PA1, CS=PA4 
//	
//	GPIOB->CRL &= 0XFFF0FF00; 
//	GPIOB->CRL |= 0X00030038;
//	
//	GPIOB->CRL &= 0XFFF0FF00; 
//	GPIOB->CRL |= 0X00030038;						//PA1,PA4????, PA0?? 	    
//	GPIOB->ODR |= (1 << 0) | (1 << 1) | (1 << 4);	//PA1,PA4,PA0??
...
//	GPIOB->CRL |= 0X30000000;	//PB7 ?? 	    
//	GPIOB->ODR |= 1 << 7;     	//PB7??
//	RCC->APB2ENR |= 1 << 4;     //??PORTC??, ??SPI??CS=PC4
//	GPIOC->CRL &= 0XFFF0FFFF; 
//	GPIOC->CRL |= 0X00030000;	//PC4 ?? 	    
//	GPIOC->ODR |= 1 << 4;     	//PC4 ??
	
//	SPI1_Init();
	TIM6_Int_Init(100, 719);	//100Khz????,???1000?10ms
