...
typedef enum
{
	...
	EEP_MAX_AQ_VAL,
	EEP_CALIBRATION_AQ = EEP_MAX_AQ_VAL + 2,  
  ...
  HUMCOUNT1_H,
	...
	EEP_MAX_MASTER,
	EEP_IS_WAGNER_PRODUCT,
	EEP_PM25_RAND_OFFSET,
	EEP_PM25_RAND_SIGN,
	EEP_DATA_BACKUP,
	
	
	EEP_HARDFAULT1,  // FOR TEST
	EEP_HARDFAULT2,  // FOR TEST
	EEP_HARDFAULT3,  // FOR TEST
	EEP_HARDFAULT4,  // FOR TEST
	EEP_HARDFAULT5,  // FOR TEST
...
typedef enum
{
	...
	MODBUS_MSTP_MAX_MASTER = 29,
	MODBUS_FLOAT_TEST_HI, // FOR TEST
	MODBUS_FLOAT_TEST_LO,
	MODBUS_FLOAT_TEST_HI_W, // FOR TEST
	MODBUS_FLOAT_TEST_LO_W,
...
//	MODBUS_RTC_SECOND,
	...
	MODBUS_ALARM_AUTO_MANUAL = 1246,	// 1246, bit7: 0 = auto, 1 = manual; bit0:1 = pre_alarm; bit1: 1 = continuous_alarm; bit(1:0): 00 = stop_ alarm		
...
//	MODBUS_IDLE_ID = MODBUS_SCAN_ONLINE_END,							//2632
  ...
  MODBUS_HUMCOUNT1_H ,	// 3007	     
	...
	MODBUS_SCREEN_AREA_1 = 3134, //3134
...
typedef enum
{
	...
	MODBUS_PM25_RAND_OFFSET,
	MODBUS_PM25_RAND_SIGN,
	MODBUS_PM25_EXTERNAL_TEMPERATURE_FAHRENHEIT, // 144   spring add reg144 ,reg145 ,reg146 
	MODBUS_PM25_EXTERNAL_TEMPERATURE_CELSIUS, //145
	MODBUS_PM25_HUMIDITY, //146
	MODBUS_PM25_END, 	
